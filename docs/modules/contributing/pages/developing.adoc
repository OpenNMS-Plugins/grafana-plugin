...
You can contribute code to the {product-name} project via https://github.com/OpenNMS-Plugins/grafana-plugin[GitHub].
...
+
[source, shell]
git clone https://github.com/OpenNMS-Plugins/grafana-plugin.git opennms-grafana-plugin
