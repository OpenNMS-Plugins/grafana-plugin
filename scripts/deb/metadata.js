...
const CONTROL_TEMPLATE = path.join('scripts', 'deb', 'debian', 'control.mustache');
...
module.exports = { renderControl, renderChangelog, toDebianDepends, formatChangelogDate, PROJECT_DIR };
